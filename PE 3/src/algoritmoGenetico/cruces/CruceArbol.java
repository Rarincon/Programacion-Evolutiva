...
public CruceArbol() {
	...
	ArrayList<Arbol> nodos_selec2 = new ArrayList<Arbol>();//Seleccionamos los nodos más relevante según la probabilidad
	...
	private void corte(Individuo hijo, Arbol temp, int puntoCruce, boolean esRaiz) {
		...
		if(seleccionaFunciones()){//Si devuelve true, el corte se hará en una funciónarbol.getFunciones(arbol.getHijos(), nodos);
